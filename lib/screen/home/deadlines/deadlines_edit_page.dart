...
// deadline edit page
class DeadlinesEdit extends StatefulWidget {
  ...
  @override
  _DeadlinesEditState createState() => _DeadlinesEditState();
}

class _DeadlinesEditState extends State<DeadlinesEdit> {
        ...
        children: <Widget>[
          Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
            ...
            createIndividualContainer(
                'Expired deadlines show 0 for day, hour and min', notesBackgroundColor, notesTextColor),
          ]),
          SizedBox(height: 5),
          Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
            SizedBox(width: 30),
            createIndividualContainer(
                'Inserting location and description is optional', notesBackgroundColor, notesTextColor),
          ]),
        ],
      ),
    );
  ...
  Widget createNCancelButton(MyUser user) {
    return Row(
      children: <Widget>[
        SizedBox(width: 80),
        ElevatedButton.icon(
          onPressed: () async {
            ...
            if (isValid) {
              ...
              await DatabaseService(uid: user.uid)
                  .editUserDeadline(widget.deadlinesEvent, event);
