...
// sign-in page of authentication
...
class _SignInState extends State<SignIn> {
  ...
  // used for validation of TextFieldForm
  final _formKey = GlobalKey<FormState>();
  String email = '';
  String password = '';
  String error = ''; // error message shown when email and password is invalid
  bool loading = false; // true to show loading screen, false by default
  bool isHidden = true;

  // design related variables
  final backgroundColor = HexColor("#12203D"); // dark blue
  final logInBackgroundColor = HexColor('#FFFFFF'); // white
  final signInSize = 22.0;
  final registerSize = 20.0;
  final signInColor = HexColor("#E46471"); // pinkish red
  final registerColor = HexColor("#27324D"); //
                ...
                Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Form(
                        key: _formKey, // track the state of our form
                        child: Column(
                          children: <Widget>[
                            SizedBox(
                                height:
                            ...
                            TextFormField(
                              ...
                              // everytime a user change an input, the new value is updated
                              onChanged: (val) {
                                setState(() {
                                  email = val;
                                });
                              ...
                              validator: (val) {
                                ...
                                if (val!.isEmpty) {
                                  return 'Enter a valid email'; // email is invalid
                                } else {
                            ...
                            TextFormField(
                              ...
                              validator: (val) {
                                ...
                                if (val!.length < 6) {
                                  // password must be at least 6 characters long to be valid
                                  return 'Enter A Password With At Least 6 Letters'; // password is invalid
                                } else {
                              ...
                              obscureText:
                                  isHidden, // letters are replaced by *
                            ...
                            TextButton(
                                ...
                                onPressed: () async {
                                  // bring to loading page
                                  setState(() {
                                    loading =
                                        true; // loading icons appears during delayed data retrival
                                  });

                                  // dynamic as result can be MyUser object or null
                                  ...
                                  if (result == null) {
                                    setState(() {
                                      error =
                                          'Invalid Email or Password'; // user is invalid
                                      loading =
                                          false; // once we get a response, we remove loading screen
                                    });
                                  }
                                }),
                            SizedBox(height: 20.0),
  ...
  // error text at the bottom of sign-in button
  ...
  // sign in button with no function
